  ...
  return (
    <div className="min-h-screen bg-[var(--gray-50)] font-['Poppins',Arial,sans-serif]">
      ...
      <main>
        ...
        <section id="contact" className="py-16 bg-[var(--primary-500)] text-white">
          <div className="card hover:shadow-xl p-8">
            <h3 className="section-title gradient-text">Get in Touch</h3>
      ...
      {/* Enhanced Footer */}
      <footer className="bg-white py-16 border-t border-[var(--gray-100)]">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            {/* Company Info */}
            <div>
              <h3 className="text-2xl font-extrabold mb-6">
                <span className="text-[var(--gray-900)]">Career</span>
                <span className="text-[var(--primary-500)]"> Sure</span>
              </h3>
              ...
              <div className="flex gap-4">
                ...
                {[
                  ...
                  <a
                    key={social.title}
                    href="#"
                    className="w-10 h-10 rounded-lg bg-[var(--primary-500)]/10 text-[var(--primary-500)] 
                             flex items-center justify-center transition-all duration-300 
                             hover:bg-[var(--primary-500)] hover:text-white hover:-translate-y-1"
                    title={social.title}
                  >
            ...
            {/* Courses */}
            <div>
              <h3 className="text-xl font-bold mb-6 text-gray-900">Courses</h3>
              {[
                "Web Development",
                "Data Science",
                ...
                <a
                  key={course}
                  href="#courses"
                  className="text-gray-600 block mb-4 transition-colors duration-300 hover:text-[#FF6B00]"
                >
                  {course}
                </a>
              ))}
            ...
            <div>
              ...
              {[
                ...
                <div key={index} className="flex items-start mb-4 group">
                  <div className="w-10 h-10 rounded-lg bg-[#FF6B00]/10 flex items-center justify-center mr-4 group-hover:bg-[#FF6B00]/20 transition-all duration-300">
                  ...
                  <span className="text-gray-600 hover:text-[#FF6B00] transition-colors duration-300">
                    {contact.text}
                  </span>
                </div>
              ))}
          ...
          {/* Copyright */}
          <div className="mt-16 pt-8 border-t border-[var(--gray-100)] text-center">
